        ...
        <div className='border-t-2 py-6 mt-12'>
            ...
            <section className='mt-3 md:flex justify-between'>
                <div className='md:w-2/3 *:leading-snug'>
                    ...
                    <p className='mt-4 text-xl'>These days, I am applying my passion and abilities to working with businesses and individuals to create beautiful pieces of graphic, branding, and web design!</p>
                </div>
                <div className='flex flex-row md:flex-col *:underline *:decoration-green-400 *:px-1 *:text-lg'>
